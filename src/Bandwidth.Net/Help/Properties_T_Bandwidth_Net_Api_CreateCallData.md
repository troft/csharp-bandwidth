# CreateCallData Properties
 

The <a href ="T_Bandwidth_Net_Api_CreateCallData.md">CreateCallData</a> type exposes the following members.
...
<a href="#createcalldata-properties">Back to Top</a>
